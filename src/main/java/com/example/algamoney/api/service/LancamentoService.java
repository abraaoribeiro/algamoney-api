...
public class LancamentoService {
	...
	public void avisarSobreLancamentosVencidos() {
		...
		if (logger.isDebugEnabled()) {
			logger.debug("Preparado envio de e-mails de aviso de lancamentos vencidos");
		}
		...
		if (destinatarios.isEmpty()) {
			logger.warn("Existem lançamentos vencidos, mas o sistema não encontrou destinatario");
		}
