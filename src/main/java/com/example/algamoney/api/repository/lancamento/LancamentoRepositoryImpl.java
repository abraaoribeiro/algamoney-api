...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	private void adicionarRegistricoesPaginacao(TypedQuery<?> query, Pageable pageable) {
	...
	public List<LancamentoEstatisticaDia> porDia(LocalDate mesReferencia) {
		...
		Root<Lancamento> root = criteriaQuery.from(Lancamento.class);
		criteriaQuery.select(criteriaBuilder.construct(LancamentoEstatisticaDia.class, root.get("tipo"),
	...
	public List<LancamentoEstatisticaPessoa> porPessoa(LocalDate inicio, LocalDate fim) {
		...
		Root<Lancamento> root = criteriaQuery.from(Lancamento.class);
		criteriaQuery.select(criteriaBuilder.construct(LancamentoEstatisticaPessoa.class, root.get("tipo"),
